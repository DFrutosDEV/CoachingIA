...
export default function EnterprisesPage() {
  ...
  const t = useTranslations('text.dashboardAdmin.enterprisesPage');
      ...
      if (response.ok && data.data) {
        setStats({
          ...
          averageEmployeesPerEnterprise:
            data.data.averageEmployeesPerEnterprise,
        });
      }
    } catch (error) {
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {t('averagePerEnterprise')} {stats.averageEmployeesPerEnterprise} {t('perEnterprise')}
                </p>
              </CardContent>
            </Card>
          </div>
