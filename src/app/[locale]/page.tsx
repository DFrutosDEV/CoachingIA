    ...
    <div className="flex flex-col min-h-screen">
      ...
      <footer className="border-t">
        ...
        <div className='flex justify-between border-t'>
          <div className="flex flex-col gap-4 md:h-16 md:flex-row md:py-4">
          ...
          <div className="flex flex-col gap-4 md:h-16 md:flex-row md:py-4 text-center text-sm text-muted-foreground items-center">
            {t('footer.author')}
            <Link href="https://www.linkedin.com/in/daniel-frutos-83b522210/" target="_blank" className="text-primary hover:text-primary-dark font-bold hover:underline">Daniel Frutos</Link>
          </div>
        </div>
      </footer>
      <ThemeToggle />
