...
export async function GET(request: NextRequest) {
  try {
    ...
    try {
      ...
      const activeEnterprisesChange =
        activeEnterprisesCount - activeEnterprisesLastMonth.length;
      ...
      const analyticsData = [
        ...
        },
        {
          ...
          change:
            activeEnterprisesChange >= 0
              ? `+${activeEnterprisesChange}`
              : `${activeEnterprisesChange}`,
        ...
        },
        {
          ...
          change:
            monthlySessionsChange >= 0
              ? `+${monthlySessionsChange}`
              : `${monthlySessionsChange}`,
