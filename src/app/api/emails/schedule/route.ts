...
import { scheduleEmail, scheduleMultipleEmails, ScheduledEmailData } from '@/lib/services/scheduled-email-service';
...
export async function GET(request: NextRequest) {
  try {
    const { getEmailStats } = await import('@/lib/services/scheduled-email-service');
