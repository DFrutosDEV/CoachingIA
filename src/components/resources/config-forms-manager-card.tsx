        ...
        <CardFooter>
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[600px] z-[9999]">
              <DialogHeader>
                <DialogTitle>Revisar Formulario de Configuración</DialogTitle>
                <DialogDescription>
                  Aquí puedes ver y gestionar todas las preguntas de
              ...
              <div className="space-y-4 py-4">
                <div className="flex justify-between items-center">
                  <h4 className="text-sm font-medium">
                    Total: {configForms.length} formularios
                  </h4>
                  <Button
                  ...
                  {configForms.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-500">
                        No hay formularios de configuración
                      </p>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent className="bg-background z-[9999]">
                  ...
                  <SelectItem className="bg-background-hover" value="optional">
                    Opcional
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent className="bg-background z-[9999]">
                  <SelectItem className="bg-background-hover" value="active">
                    Activa
                  </SelectItem>
                  <SelectItem className="bg-background-hover" value="inactive">
                    Inactiva
                  </SelectItem>
                </SelectContent>
              </Select>
