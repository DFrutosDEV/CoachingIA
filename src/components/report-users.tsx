import { FileText, ArrowRight, AlertTriangle, MessageSquare, XCircle } from "lucide-react";
...
export function ReportUsers({ reports, onViewReport, isLoading }: ReportUsersProps) {
  if (isLoading) {
    return (
